...
export default function DashboardPage() {
  ...
  const resumeLimits = user.planType === "free" ? 3 : "unlimited";
  const resumesThisMonth = 2;
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">You've created {resumesThisMonth} of {resumeLimits} resumes this month.</p>
        </div>
